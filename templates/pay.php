...
<h2>订单状态：<span id="order-status"
        class="<?php echo $order_status == 'pending' ? 'text-orange-500' : ($order_status == 'paid' ? 'text-green-500' : 'text-red-500'); ?>"
        data-order-id="<?= $order_id ?>"><?= $order_status ?></span></h2>
